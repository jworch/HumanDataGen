 ...
 */
public class MainUploadReducedData_sp 
        extends Configured
        implements Tool
{
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new MainUploadReducedData_sp(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        // parse the arguments
        if( args.length != 2 ) {
            System.err.println("usage: hadoop xxx.jar uploadreduced_sp <localfilein.dat> <hdfsfileout.seq>");
            return -1;
        }
        ...
        try {
            ...
            while(true && numRecords<1000*1000) {
